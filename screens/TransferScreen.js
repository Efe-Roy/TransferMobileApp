...
export default function TransferScreen() {
  ...
  return (
    <View className="flex-1 bg-white px-8 pt-24">
        <Text className="text-center font-black text-3xl mb-10">Transfer Funds</Text>
        ...
        <View className="form space-y-2">
          ...
          <TextInput 
            ...
            value={amount}
          />
          <Text className="text-gray-700 ml-4">Account Number</Text>
          <TextInput 
